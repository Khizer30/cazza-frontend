  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "bg-accent text-accent-foreground rounded-md font-bold border-2 border-primary",
