        ...
        <div className="space-y-10 text-gray-800 leading-relaxed max-w-2xl mx-auto">
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              information when you use our services, including our web
              application ("SCAi"), website, and integrations with third-party
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              third-party providers may process data in other jurisdictions
              (e.g. US). Where data is transferred outside the UK/EU, we ensure
          ...
          <section className="space-y-4">
            ...
            <p>
              Requests can be made by emailing [Insert DPO email]. We will
          ...
          <section className="space-y-4">
            ...
            <p>
              For questions, concerns, or to exercise your rights, please
              contact:
            </p>
