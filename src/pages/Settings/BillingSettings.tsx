...
export const BillingSettings = () => {
  ...
  const hasNoSubscription =
    !subscriptionDetails || (subscriptionDetails.status !== "ACTIVE" && !subscriptionDetails.hasStripeSubscription);
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3 p-4 bg-accent/50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Ask questions about your sales, profit margins, VAT threshold, and get instant answers.
                          Unlimited AI searches with full chat history.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-accent/50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Connect Amazon Seller Central, Shopify, TikTok Shop, and Xero to sync your sales and financial
                          data in real-time.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-accent/50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          View live revenue, profit & loss statements, expenses, and performance metrics across all your
                          connected platforms.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-accent/50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Create dedicated finance channels for your team, invite members, and collaborate on financial
                          discussions with real-time messaging.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="ml-4">
                      <Badge
                        variant={
                          isActive ? "default" : subscriptionDetails.status === "CANCELED" ? "destructive" : "outline"
                        }
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-accent rounded-lg">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="font-semibold text-lg text-accent-foreground">Monthly Total</h3>
