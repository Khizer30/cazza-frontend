...
export const createChatService = (payload?: CREATE_CHAT_PAYLOAD) => {
  return apiInvoker<CREATE_CHAT_RESPONSE>(END_POINT.chatbot.createChat, "POST", payload || {});
};

export const getAllChatsService = () => {
  return apiInvoker<GET_ALL_CHATS_RESPONSE>(END_POINT.chatbot.getAllChats, "GET");
};

export const getChatService = (chatId: string) => {
  return apiInvoker<GET_CHAT_RESPONSE>(END_POINT.chatbot.getChat(chatId), "GET");
};

export const updateChatTitleService = (chatId: string, payload: UPDATE_CHAT_TITLE_PAYLOAD) => {
  return apiInvoker<UPDATE_CHAT_TITLE_RESPONSE>(END_POINT.chatbot.updateChatTitle(chatId), "PUT", payload);
};

export const deleteChatService = (chatId: string) => {
  return apiInvoker<DELETE_CHAT_RESPONSE>(END_POINT.chatbot.deleteChat(chatId), "DELETE");
};
...
export const deleteMessageService = (messageId: string) => {
  return apiInvoker<CHATBOT_DELETE_MESSAGE_RESPONSE>(END_POINT.chatbot.deleteMessage(messageId), "DELETE");
};
