...
//   const { platformRevenue, monthlyRevenue, totalRevenue, loading, error } = usePlatformRevenue();
...
//     ? ((monthlyRevenue[monthlyRevenue.length - 1]?.total_revenue - monthlyRevenue[monthlyRevenue.length - 2]?.total_revenue) / monthlyRevenue[monthlyRevenue.length - 2]?.total_revenue * 100)
//     : 0;
...
//             </CardTitle>
//             <CardDescription>
//               Platform revenue breakdown for the period: {dateRange.from ? format(dateRange.from, 'MMM dd, yyyy') : 'N/A'} to {dateRange.to ? format(dateRange.to, 'MMM dd, yyyy') : 'N/A'}
//             </CardDescription>
//           </CardHeader>
//         </Card>
//       )}
...
//                 {growthRate !== 0 && (
//                   <p className={`text-xs flex items-center gap-1 ${growthRate > 0 ? 'text-success' : 'text-destructive'}`}>
...
//                   {platformRevenue.filter(p => p.total_revenue > 0).length} with revenue
//                 </p>
//               </div>
...
//                     ? format(new Date(platformRevenue.find(p => p.last_sync)?.last_sync || ''), 'MMM dd, HH:mm')
//                     : 'Never'
//                   }
//                 </p>
...
//             </CardTitle>
//             <CardDescription>Monthly financial overview from all connected platforms</CardDescription>
//             {/* Toggle Chips */}
...
//                 />
//                 <Tooltip 
//                   formatter={(value: number) => [`£${value.toLocaleString()}`, chartView === 'revenue' ? 'Revenue' : chartView === 'profit' ? 'Profit' : 'Expenses']}
...
//                         <Cell 
//                           key={`cell-${index}`} 
//                           fill={PLATFORM_COLORS[entry.platform as keyof typeof PLATFORM_COLORS] || PLATFORM_COLORS.other} 
//                         />
//                       ))}
//                     </Pie>
...
//                           style={{ 
//                             backgroundColor: PLATFORM_COLORS[platform.platform as keyof typeof PLATFORM_COLORS] || PLATFORM_COLORS.other 
//                           }} 
//                         />
...
//                 <p className="text-sm mt-1">Connect your sales platforms to see revenue breakdown</p>
//               </div>
//             )}
//           </CardContent>
//         </Card>
...
//           <CardDescription>Detailed breakdown by connected platform</CardDescription>
//         </CardHeader>
//         <CardContent>
//           <div className="space-y-4">
...
//                       Last sync: {format(new Date(platform.last_sync), 'MMM dd, HH:mm')}
//                     </div>
//                   )}
//                 </div>
//               </div>
...
//                 <p className="text-sm mt-1">Go to Sales Platforms to connect your accounts</p>
//               </div>
//             )}
//           </div>
//         </CardContent>
