...
export const ProfitLossStatement = () =>
{
  ...
  const previousData = tiktokShopData.length > 1 ? tiktokShopData[tiktokShopData.length - 2] : null;
  ...
  const profitGrowth =
    latestData && previousData
      ? ((latestData["Net Profit (£)"] - previousData["Net Profit (£)"]) /
        previousData["Net Profit (£)"]) *
      100
      : 0;
          ...
          <CardContent className="p-4 py-2">
            <div className="flex items-center justify-between">
              <div>
                ...
                { profitGrowth !== 0 && (
                  <p
                    className={ `text-xs flex items-center gap-1 ${ profitGrowth > 0 ? "text-success" : "text-destructive"
                      }` }
                  >
                    { profitGrowth > 0 ? "+" : "" }
