...
import type { FORGOTPASSWORD_PAYLOAD, FORGOTPASSWORD_RESPONSE, LOGIN_PAYLOAD, LOGIN_RESPONSE, SETNEWPASSWORD_PAYLOAD, SETNEWPASSWORD_RESPONSE, SIGNUP_PAYLOAD, SIGNUP_RESPONSE } from "@/types/auth";
