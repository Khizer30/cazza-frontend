...
import type { FORGOTPASSWORD_PAYLOAD, FORGOTPASSWORD_RESPONSE, GOOGLE_AUTH_RESPONSE, GOOGLE_CALLBACK_PAYLOAD, GOOGLE_CALLBACK_RESPONSE, LOGIN_PAYLOAD, LOGIN_RESPONSE, SETNEWPASSWORD_PAYLOAD, SETNEWPASSWORD_RESPONSE, SIGNUP_PAYLOAD, SIGNUP_RESPONSE } from "@/types/auth";
